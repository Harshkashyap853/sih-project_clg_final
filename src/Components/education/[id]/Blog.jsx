  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-10 px-4 h-[600px] w-[1200px]">
        <h2 className="text-3xl font-bold mb-12 text-center text-black">{blog.title}</h2>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-white border border-gray-400 p-6 rounded-lg shadow-md">
            <img
              src={blog.image}
          ...
          <div className="lg:col-span-1 bg-white border border-gray-400 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-6">Random Blogs</h3>
