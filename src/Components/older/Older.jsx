...
import eimg from "../../Assets/exerciseimage.jpg";
import neimg from '../../Assets/dietimage (1).jpg';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white py-10 bg-white w-[1200px] ml-[245px] ">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-[90%] max-w-5xl bg-white">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <img
            src={eimg} // Replace with your image URL
            alt="Exercises"
          ...
          <div className="p-4">
            ...
            <a
              href="/olderexercise" // Link to your exercises page
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <img
            src={neimg} // Replace with your image URL
            alt="Diet"
          ...
          <div className="p-4">
            ...
            <a
              href="/olderdiet" // Link to your diet page
              className="text-blue-500 hover:underline mt-4 inline-block"
            >
              Know More
            </a>
